...
приведение к трехдиагональному виду унитарным подобием методом отражений матрицу за (n-2) шага 
	1. 
...
QR алгоритм в варианте "метода отражений" поиска собственных значений для симметричных матриц подпрограмма получает на вход:
n - размерность заданной матрицы;
